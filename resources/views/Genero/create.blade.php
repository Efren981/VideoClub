        ...
        <div class="col-6 ">
            <div class="card">
              <h1 class=" card-title mt-2 alert-primary text-center">Registrar nuevo genero</h1>
                <div class="row d-flex justify-content-center">
                    <div class="col-7">
                        <form method="POST" action="{{url("registro_genero")}}">
                            @csrf
                            ...
                            <div class="row my-5 d-flex justify-content-center">
                                <div class="col-3"></div>
                                <div class="col-3">
                                    <a href="{{url("registro_genero")}}" class="btn btn-danger mb-4 text-white"><span class="icon-arrow-thin-left" data-toggle="tooltip" title="Regresar al menu principal">Cancelar</span></a>
